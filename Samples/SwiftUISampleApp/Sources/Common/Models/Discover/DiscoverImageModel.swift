...
final public class DiscoverImageModel: BaseModel {
    ...
    @IOJsonProperty(key: "userProfilePicturePublicId", transformer: IOModelDateTimeTransformer(dateFormat: IOModelDateTimeTransformer.iso8601DateFormat))
