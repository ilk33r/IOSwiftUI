...
extension IOLocalizationType {
    ...
    static let buttonFollow = IOLocalizationType(rawValue: "profile.button.follow")
    static let buttonFriends = IOLocalizationType(rawValue: "profile.button.friends")
